...
then
    ...
    data_folder="/projects/p20519/roller_output/large_networks/RandomForest/omranian"
    output_folder="/projects/p20519/roller_output/large_networks/RandomForest/omranian_"
