...
for td_window in window_sizes:
    ...
    for network in network_list:
        ...
        baseline_mean=baseline[stat].mean()
        comparisons['percent_{}'.format(stat)] = ((comparisons[stat]-baseline_mean)/baseline_mean)*100
        overall_df = overall_df.append(comparisons.iloc[0,:], ignore_index = True)
...
fig.savefig('Dionesus_10_AUPR_window_scan.png')
...
ax.set_xlabel('Window Size')
fig.savefig('Dionesus_10_AUROC_window_scan.png')
