...
for network_index in range(1,6):
    ...
    for inf_method in inf_list:
        ...
        run_params['file_path'] = "/projects/p20519/Roller/data/dream4/insilico_size10_" + str(network_index) + "_timeseries.tsv"
...
"""
import pickle
#pickle.dump(network_results, open("merged_results_td_window_15.p","wb"))
pdb.set_trace()
