...
methods_of_interest = ['Dionesus-td_6', 'Dionesus-td_4', 'RF-td_6', 'RF-td_4', 'Lasso-td_6','Lasso-td_4']
...
for method in methods_of_interest:
    ...
    run_params['data_folder'] = "/projects/p20519/roller_output/large_networks/" + str(inf_method) +"/omranian_ver2_"
...
for method in methods_of_interest:
    ...
    pickle_name = '/projects/p20519/roller_output/pickles/omranian_promotion_short_lag03.pkl'
