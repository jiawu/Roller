...
methods_of_interest = ['Dionesus-td_6', 'Dionesus-td_5', 'Dionesus-td_4','Dionesus-ml_0', 'Dionesus-ml_1', 'Dionesus-ml_2','Dionesus-ml_3','Dionesus-ml_4', 'RF-td_6', 'RF-td_5', 'RF-td_4', 'RF-ml_0', 'RF-ml_1', 'RF-ml_2','RF-ml_3','RF-ml_4', 'Lasso-td_6', 'Lasso-td_5', 'Lasso-td_4','Lasso-ml_0','Lasso-ml_1','Lasso-ml_2','Lasso-ml_3','Lasso-ml_4']
...
for method in methods_of_interest:
    ...
    run_params['file_path'] = "/home/jjw036/Roller/data/invitro/omranian_parsed_timeseries.tsv"
    run_params['data_folder'] = "/projects/p20519/roller_output/large_networks/" + str(inf_method) +"/omranian_"
    run_params['td_window'] = td_window
    run_params['min_lag'] = min_lag
    run_params['max_lag'] = max_lag
    run_params['n_trees'] = 100
    run_params['bootstrap_n'] = 5
...
for method in methods_of_interest:
    diff_name = 'Dionesus-td_6-' + method
    true_only[diff_name] = true_only['rank_importance_Dionesus-td_6']-true_only['rank_importance_'+method]
    pickle_name = '/projects/p20519/roller_output/pickles/omranian_promotion.pkl'
