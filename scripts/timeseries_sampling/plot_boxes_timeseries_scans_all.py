...
#sampling_rates = [10, 30, 50, 100, 200, 333, 500]
#overall_df, network_1 = get_comparisons(merged_df, inftypes, sampling_rates, network_list)

#overall_df.to_pickle("merged_sampling_comparisons.pkl")
#network_1.to_pickle("merged_sampling_comparisons_network1.pkl")
overall_df = pd.read_pickle("merged_sampling_comparisons.pkl")
network_1 = pd.read_pickle("merged_sampling_comparisons_network1.pkl")
...
g.savefig('combined_10_AUPR_sampling_scan.pdf')
