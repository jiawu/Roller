...
def parse_tdr_results(agg_df,test_statistic, datasets):
    ...
    for dataset in datasets:
        ...
        SWING_RF = current_df[(current_df['td_window'] == 15) & (current_df['min_lag']==1) & (current_df['max_lag'] == 3) & (current_df['data_folder'].str.contains('RandomForest'))]
        SWING_Lasso = current_df[(current_df['td_window'] == 15) & (current_df['min_lag']==1) & (current_df['max_lag'] == 3) & (current_df['data_folder'].str.contains('Lasso'))& (current_df['data_folder'].str.contains('yeast') )]
        SWING_Dionesus = current_df[(current_df['td_window'] == 15) & (current_df['min_lag']==1) & (current_df['max_lag'] == 3) & (current_df['data_folder'].str.contains('Dionesus'))& (current_df['data_folder'].str.contains('yeast') )]
        SWING_Community = current_df[(current_df['td_window'] == 15) & (current_df['min_lag']==1) & (current_df['max_lag'] == 3) & (current_df['data_folder'].str.contains('community'))& (current_df['data_folder'].str.contains('yeast') )]
        ...
        SWING_RF2 = current_df[(current_df['td_window'] == 15) & (current_df['min_lag']==1) & (current_df['max_lag'] == 3) & (current_df['data_folder'].str.contains('RandomForest'))& (current_df['data_folder'].str.contains('ecoli') )]
        SWING_Lasso2 = current_df[(current_df['td_window'] == 15) & (current_df['min_lag']==1) & (current_df['max_lag'] == 3) & (current_df['data_folder'].str.contains('Lasso'))& (current_df['data_folder'].str.contains('ecoli') )]
        SWING_Dionesus2 = current_df[(current_df['td_window'] == 15) & (current_df['min_lag']==1) & (current_df['max_lag'] == 3) & (current_df['data_folder'].str.contains('Dionesus'))& (current_df['data_folder'].str.contains('ecoli') )]
        SWING_Community2 = current_df[(current_df['td_window'] == 15) & (current_df['min_lag']==1) & (current_df['max_lag'] == 3) & (current_df['data_folder'].str.contains('community'))& (current_df['data_folder'].str.contains('ecoli') )]
...
save_tag = "gnw_all_differences_net"
n_trials = 100
