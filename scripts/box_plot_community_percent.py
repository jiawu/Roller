...
def parse_tdr_results(agg_df,test_statistic, datasets):
    ...
    for dataset in datasets:
        ...
        for c in comparison_range:
            selection = current_df[(current_df['td_window'] == c) & (current_df['min_lag']==1) & (current_df['max_lag'] == 3) & (current_df['data_folder'].str.contains('Dionesus')) & (current_df['data_folder'].str.contains('yeast'))]
            comparisons.append(selection)

        Ref2 = current_df[(current_df['td_window'] == 21) & (current_df['data_folder'].str.contains('Dionesus')) & (current_df['data_folder'].str.contains('ecoli'))]
