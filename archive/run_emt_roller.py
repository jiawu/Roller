...
def plot_lines(series_list, regulator_labels, target_labels, window_size, suffix=""):
    ...
    lines = []
    time = [x for x in range(0,11-window_size)]
    label_list = []
...
tfs_of_interest = [(present_genes_jj.index("ER"),present_genes_ii.index("E2F")),(present_genes_jj.index("LHX8"),present_genes_ii.index("FOXA")),(present_genes_jj.index("P53"), present_genes_ii.index("LHX8"))]
regulator_labels = ["ER","LHX8","P53"]
target_labels = ["E2F","FOXA","LHX8"]

for coord in tfs_of_interest:
    row_index = coord[1]
    col_index = coord[0]
    present_coeffs_over_time = present_mat[row_index,col_index,:]
    series_list.append(present_coeffs_over_time)

plot_lines(series_list, regulator_labels, target_labels, window_size, suffix="example")
